...
public class ViewResult extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		Tree tree1 = new Tree(container, SWT.NONE);
		 tree1 = new Tree(container,SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
		 tree1.setBounds(0, 0, 200, 469);
		 tree1.setHeaderVisible(true);
		 tree1.setLinesVisible(true);
		 
		//Create Tree_2 for showing result of parsing UML 
		 Tree tree2 = new Tree(container, SWT.None);
		 tree2 = new Tree(container,SWT.BORDER | SWT.H_SCROLL | SWT.H_SCROLL | SWT.V_SCROLL);
		 tree1.setBounds(200, 0, 200, 469);
		 tree2.setHeaderVisible(true);
		 tree2.setLinesVisible(true); 
		 
		//Create Tree_3 for showing result of Comparison
		 Tree tree3 = new Tree(container, SWT.None);
		 tree3 = new Tree(container,SWT.BORDER | SWT.H_SCROLL | SWT.H_SCROLL | SWT.V_SCROLL);
		 tree1.setBounds(400, 0, 200, 469);
...
//		    subItem2.setText(new String[]{"               subItem2","no","99"});
	...
	public void showResults(){
		...
		columnSourceClasses.setWidth(200);
		...
		columnUmlClasses.setWidth(200);
		
		//Tree 3
		TreeColumn columnCompare = new TreeColumn(tree2, SWT.CENTER);
		columnCompare.setText("Compare Result");
		columnCompare.setWidth(200);
